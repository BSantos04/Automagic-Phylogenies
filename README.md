...
# Pull Docker image
docker pull ynotbs/nextflow:latest
```
...
With outgroup:
```
nextflow pipeline.nf --o "Arothron carduus" --t "genus" --docker "ynotbs/nextflow:latest" --outgroup "Cheilopogon agoo"
```

Without outgroup:
```
nextflow pipeline.nf --o "Arothron carduus" --t "genus" --docker "ynotbs/nextflow:latest"
```
